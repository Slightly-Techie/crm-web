...
function Navbar() {
  ...
  return (
    <div className="w-full bg-st-bg dark:bg-[#0202022f] backdrop-saturate-200 dark:text-st-edge lg:sticky z-50 top-0 h-20 backdrop-blur-sm px-8 md:px-16 lg:px-24 xl:px-48 py-4 flex justify-between items-center border-b-solid border-b-[#cecece73] border-b-[1px]">
      <Link href={"/"}>
