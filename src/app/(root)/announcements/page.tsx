      ...
      <div className="p-6 md:p-8 lg:p-12 max-w-7xl mx-auto w-full">
        ...
        <div className="mb-12">
          <div className="flex items-end justify-between gap-6 mb-4">
            <div>
              <h1 className="text-4xl md:text-5xl font-extrabold text-on-surface font-headline">
                Announcements
              </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              {featuredAnnouncement && (
                <section className="space-y-4">
                  ...
                  <article className="bg-surface-container-lowest rounded-xl overflow-hidden shadow-sm group border border-outline-variant/10 hover:shadow-md transition-shadow">
                    <div className="h-48 md:h-64 relative overflow-hidden bg-stone-200">
                      ...
                      <div className="absolute top-4 left-4">
                        <span className="bg-primary text-on-primary px-4 py-2 rounded-full text-[10px] font-bold uppercase tracking-wider shadow-md">
                          Featured
                        </span>
                      </div>
                    </div>
                    <div className="p-8">
                      ...
                      <h3 className="text-3xl font-bold font-headline mb-4 text-on-surface group-hover:text-primary transition-colors cursor-pointer">
                        {featuredAnnouncement.title}
                      </h3>
                      <p className={`text-on-surface-variant leading-relaxed mb-6 text-base ${expandedAnnouncement === featuredAnnouncement.id ? "" : "line-clamp-3"}`}>
                      ...
                      <div className="flex items-center justify-between pt-6 border-t border-outline-variant/20">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={() => setExpandedAnnouncement(expandedAnnouncement === featuredAnnouncement.id ? null : featuredAnnouncement.id)}
                            className="text-primary font-bold text-sm hover:underline flex items-center gap-1 group"
                          >
                            <span>{expandedAnnouncement === featuredAnnouncement.id ? "Show less" : "Read more"}</span>
                            <span className="material-symbols-outlined text-sm group-hover:translate-x-1 transition-transform">
                              {expandedAnnouncement === featuredAnnouncement.id ? "expand_less" : "arrow_forward"}
                            </span>
                          </button>
                        </div>
                      </div>
              ...
              {restAnnouncements.length > 0 && (
                <section className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-sm font-bold uppercase tracking-widest text-on-surface-variant">
                      Recent Updates ({restAnnouncements.length})
                    </h2>
                    <div className="flex-1 h-px bg-outline-variant/30" />
                  </div>
                  <div className="space-y-4">
                    {restAnnouncements.map((announcement: any) => (
                      ...
                      >
                        {/* Thumbnail */}
                        <div className="md:w-48 h-40 rounded-lg overflow-hidden shrink-0 bg-stone-200">
                        ...
                        <div className="flex-1 flex flex-col justify-between">
                          <div>
                            ...
                            <p className={`text-on-surface-variant text-sm mb-4 ${expandedAnnouncement === announcement.id ? "" : "line-clamp-2"}`}>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              ...
                              className="text-primary font-semibold text-xs hover:underline flex items-center gap-1 group"
                            >
                              ...
                              <span className="material-symbols-outlined text-xs group-hover:translate-x-1 transition-transform">
                                {expandedAnnouncement === announcement.id ? "expand_less" : "arrow_forward"}
                              </span>
                            </button>
                          </div>
                        </div>
            ...
            <aside className="lg:col-span-4 space-y-8">
              ...
              <div className="space-y-0">
                ...
                {spotlightMember ? (
                  <div className="bg-gradient-to-br from-primary to-emerald-700 rounded-xl p-6 text-white space-y-4 mb-8">
                    <div className="flex items-center gap-2">
                  ...
                  <div className="bg-surface-container-low rounded-xl p-6 relative overflow-hidden mb-8">
          ...
          !isLoading && (
            <div className="text-center py-20">
              ...
              {filteredAnnouncements.length === 0 && searchQuery && (
                <p className="text-sm text-on-surface-variant mt-2">Try adjusting your search</p>
              )}
            </div>
          )
        )}
