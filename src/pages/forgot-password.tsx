        ...
        <div className="right w-1/2">
            ...
            <form>
                ...
                <div className="mt-[40px] mb-5">
                    <input className='bg-[#1E1E1E] border-[#353535] rounded-sm border-[1.8px] h-[40px] w-[20rem] placeholder:text-[14px] placeholder:text-[#353535] pl-4 focus:outline-none focus:border-white border-[1.8px]' type="email" name="email" placeholder='Johndoe@slightytechie.io' required />
                </div>
            
                <button id="btn" role="btn" type="submit" >Reset Password</button>
                        
            
                <p className="mt-7 text-center text-[12px]">Go back to <Link to="/"><u className="font-bold hover:text-gray-400">Sign In</u></Link></p>
