...
function Recent() {
  return (
    <div className="bg-blue-200 w-96 bg-white dark:bg-[#232323] border border-[#DCDDE1] dark:border-[#353535] rounded-sm">
      <div className="border-b border-[#DCDDE1] dark:border-[#353535] pt-4 pb-4">
      ...
      <div className="border-b border-[#DCDDE1] dark:border-[#353535]">
